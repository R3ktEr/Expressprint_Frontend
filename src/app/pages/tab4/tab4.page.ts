...
export class Tab4Page implements OnInit {
  ...
  constructor(private fb:FormBuilder, private pricesService:PriceService, private notS:NotificationsService, private authS:AuthService, 
    @Inject(LOCALE_ID) private locale: string, private navCtrl:NavController) {
  ...
  public async saveOrder(){
    ...
    let sizes:Size=this.actualPrices.Sizes.filter(s=>s.sheetSize===this.formOrder.get("size").value)[0];
